...
func (fake *fakeAccount) Search(query string, page int) (*client.SearchResult, error) {
	fake.gotQuery = query
	fake.gotPage = page
...
func (fake *fakeAccount) Notifications() ([]client.Notification, error) {
	return fake.notify, fake.notifyErr
}
